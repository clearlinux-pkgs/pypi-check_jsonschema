...
Source0  : https://files.pythonhosted.org/packages/84/52/07a76a51fba27592c2b24ebc0426e1bb84af77220c89deed2e03fd67f40c/check_jsonschema-0.30.0.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.30.0
cd %{_builddir}/check_jsonschema-0.30.0
pushd ..
cp -a check_jsonschema-0.30.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735094220
