...
Source0  : https://files.pythonhosted.org/packages/3a/63/46ada3bfef271aa4c5ccc86a01a2ca521bfa3a0d7b083dbe76e8adcc460c/check_jsonschema-0.29.2.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.29.2
cd %{_builddir}/check_jsonschema-0.29.2
pushd ..
cp -a check_jsonschema-0.29.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724363141
