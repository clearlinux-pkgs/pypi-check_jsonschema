...
Source0  : https://files.pythonhosted.org/packages/f9/e0/3378b03943ac488797e99be0b2f035cd8a410a4f51f0a6a593dc50a77566/check_jsonschema-0.31.2.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.31.2
cd %{_builddir}/check_jsonschema-0.31.2
pushd ..
cp -a check_jsonschema-0.31.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740063581
