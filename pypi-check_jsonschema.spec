...
Source0  : https://files.pythonhosted.org/packages/5c/68/a2c997e461be3e6d5d70130759ceba14dedcac565c7d1458e568cc6ec5f1/check_jsonschema-0.31.3.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.31.3
cd %{_builddir}/check_jsonschema-0.31.3
pushd ..
cp -a check_jsonschema-0.31.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742454148
