...
Source0  : https://files.pythonhosted.org/packages/88/d4/1751a16868afea8d369444022d5c2e6ee65db90755fa0d77d050f7c012ed/check_jsonschema-0.31.1.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.31.1
cd %{_builddir}/check_jsonschema-0.31.1
pushd ..
cp -a check_jsonschema-0.31.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738267445
