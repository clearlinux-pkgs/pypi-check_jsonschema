...
Source0  : https://files.pythonhosted.org/packages/97/e1/4a2e5d2113f685f316be2365caf3ffd3f9cd7c90ebcdfc433576942a1a91/check_jsonschema-0.29.1.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.29.1
cd %{_builddir}/check_jsonschema-0.29.1
pushd ..
cp -a check_jsonschema-0.29.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722274314
