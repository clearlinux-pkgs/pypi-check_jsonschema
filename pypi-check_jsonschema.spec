...
Source0  : https://files.pythonhosted.org/packages/f3/6b/8012fec3d1ea3db72d17ba49df0b77d6f37272e26ce8d0835b4a02c3ce1a/check_jsonschema-0.29.0.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.29.0
cd %{_builddir}/check_jsonschema-0.29.0
pushd ..
cp -a check_jsonschema-0.29.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720479755
