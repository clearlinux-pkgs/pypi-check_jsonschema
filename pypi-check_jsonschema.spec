...
Source0  : https://files.pythonhosted.org/packages/e4/e3/09ffb25031e090ef48e87e13695d2ca7b75b8d691167d8336e0fa631ebcb/check_jsonschema-0.28.5.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.28.5
cd %{_builddir}/check_jsonschema-0.28.5
pushd ..
cp -a check_jsonschema-0.28.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718228528
