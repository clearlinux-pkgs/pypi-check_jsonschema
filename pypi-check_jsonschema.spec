...
Source0  : https://files.pythonhosted.org/packages/ce/82/b0f048a5f96d67362ea313759daf4baf92e4e9ee1c416947efa6d3feaf0e/check-jsonschema-0.28.0.tar.gz
...
%prep
%setup -q -n check-jsonschema-0.28.0
cd %{_builddir}/check-jsonschema-0.28.0
pushd ..
cp -a check-jsonschema-0.28.0 buildavx2
popd
pushd ..
cp -a check-jsonschema-0.28.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707234341
