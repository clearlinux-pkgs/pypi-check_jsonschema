...
Source0  : https://files.pythonhosted.org/packages/fb/c6/abcd484d6f7682c1316a374c5808f8040cf6cfc73995f38734deecce7e42/check-jsonschema-0.21.0.tar.gz
...
%prep
%setup -q -n check-jsonschema-0.21.0
cd %{_builddir}/check-jsonschema-0.21.0
pushd ..
cp -a check-jsonschema-0.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674660494
