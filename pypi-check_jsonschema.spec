...
Source0  : https://files.pythonhosted.org/packages/c6/62/4e2291834222dceab6f16d65bc6cc8cf601682687dd998aca0ba244cc7b6/check_jsonschema-0.31.0.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.31.0
cd %{_builddir}/check_jsonschema-0.31.0
pushd ..
cp -a check_jsonschema-0.31.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736348447
