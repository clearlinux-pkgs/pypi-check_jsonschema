...
Source0  : https://files.pythonhosted.org/packages/f6/fd/2eb043e0a792279684d2a69679bba19a0d8766171d20fb28e4194d986f1c/check_jsonschema-0.32.1.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.32.1
cd %{_builddir}/check_jsonschema-0.32.1
pushd ..
cp -a check_jsonschema-0.32.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743001268
