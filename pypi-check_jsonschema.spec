...
Source0  : https://files.pythonhosted.org/packages/33/ab/1f2ba494c28e516e5aa090a1a02bf23758310421d1a376be040d86cc118a/check-jsonschema-0.27.2.tar.gz
...
%prep
%setup -q -n check-jsonschema-0.27.2
cd %{_builddir}/check-jsonschema-0.27.2
pushd ..
cp -a check-jsonschema-0.27.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701288444
