...
Source0  : https://files.pythonhosted.org/packages/c3/fd/dc07a94d3cc000b2dd9a1a7180d198814d6befd36662676aae8d05b78ca7/check_jsonschema-0.28.6.tar.gz
...
%prep
%setup -q -n check_jsonschema-0.28.6
cd %{_builddir}/check_jsonschema-0.28.6
pushd ..
cp -a check_jsonschema-0.28.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719248289
